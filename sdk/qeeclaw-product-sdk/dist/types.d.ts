...
export interface ProductSdkClient {
    ...
    file: {
        listDocuments(params?: {
            skip?: number;
            limit?: number;
        }): Promise<ProductPlatformDocument[]>;
    ...
    knowledge: {
        list(payload: ProductRuntimeKnowledgeScope & {
            page?: number;
            pageSize?: number;
        ...
        updateConfig(payload: ProductRuntimeKnowledgeScope & {
            watchDir: string;
        }): Promise<Record<string, unknown>>;
    ...
    conversations: {
        ...
        listGroups(params: {
            teamId: number;
            limit?: number;
        }): Promise<ProductConversationGroup[]>;
        listGroupMessages(params: {
            teamId: number;
            roomId: string;
            limit?: number;
